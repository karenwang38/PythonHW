...
class JSONPipeline(object):
    def open_spider(self, spider):
        ...
        self.dir_path = Path(__file__).resolve().parents[1] / 'collect_data'
        self.runtime_file_path = str(self.dir_path / '.tmp.json.swp')
        
        spider.log('dir_path: {}'.format(self.dir_path))
#         spider.log('self.runtime_file_path: ',self.runtime_file_path)
    ...
    def close_spider(self, spider):
        ...
        if spider.name == 'PTTFirst' and spider.filename:
